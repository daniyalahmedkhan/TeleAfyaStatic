...
public class Nurses_Tab extends android.support.v4.app.Fragment{

    public ViewPager viewPager;
    public TabLayout tabLayout;
    public ArrayList<Fragment> arrayList;
    public Nurses nurses;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nurses_tab,null);
        initView(view);
    ...
    private void initView(View view) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("NURSES"));
